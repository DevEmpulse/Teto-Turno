    ...
    <div className="animate-in">
      <div className="mb-6">
        <Link
          ...
          className="inline-flex cursor-pointer items-center gap-2 text-sm font-medium text-surface-600 hover:text-surface-900 dark:text-surface-400 dark:hover:text-surface-100"
        >
